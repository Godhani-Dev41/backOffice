...
export const routes = [
  {
    ...
    children: [
      ...
      { path: "leagues", loadChildren: "./pages/leagues/leagues.module#LeaguesModule" },
...
*/
      { path: "facilities", loadChildren: "./pages/venues/venues.module#VenuesModule" },
      { path: "widgets", component: WidgetsComingSoonComponent },
      { path: "tournaments", loadChildren: "./pages/tournaments/tournaments.module#TournamentsModule" },

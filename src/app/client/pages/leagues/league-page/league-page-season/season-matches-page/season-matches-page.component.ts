...
export class SeasonMatchesPageComponent implements OnInit {
  ...
  @ViewChild('cancelConfirmModal') cancelConfirmModal: ConfirmationModalComponent;
  @ViewChild(DatatableComponent) table: DatatableComponent;
  @ViewChild('matchEditModal') matchEditModal: MatchEditModalComponent;
  @ViewChild('changeTimeModal') changeTimeModal: BulkChangeTimeModalComponent;
  @ViewChild('venueSelectModal') venueSelectModal: VenueSelectModalComponent;
  @ViewChild('scheduleUploaderModal') scheduleUploaderModal: ScheduleXlsUploadModalComponent;

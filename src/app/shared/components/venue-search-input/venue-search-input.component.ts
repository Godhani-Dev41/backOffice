...
import {
  Component, EventEmitter, forwardRef, Input, NgZone, OnDestroy, OnInit, Output,
  ViewChild
} from '@angular/core';
...
export class VenueSearchInputComponent implements OnInit, ControlValueAccessor, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.subscriptionObserver = this.typedObservable$.pipe(
      debounceTime(300),
  ...
  itemSelected(selectedItem: SelectItem) {

...
const API_DOMAIN = "https://demo-api.bondsports.co";
...
export const environment = {
  ...
  SITE_URL: "https://demo-bond-backoffice.netlify.app/login",
  CONSUMER_SITE_URL: "https://demand-web-git-demo.bondsports.vercel.app/",
  MOBILE_LEAGUE_URL: "https://demo-bond-mobile.netlify.app/app/league/",
  DEBUG_RECOIL: false,
};
